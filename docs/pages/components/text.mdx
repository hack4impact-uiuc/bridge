...
### System Props
`Text` includes `COMMON` and `TYPOGRAPHY` system props. Read [System Props](/components/system-props) for details and API. These system props will override component props such as the color.
