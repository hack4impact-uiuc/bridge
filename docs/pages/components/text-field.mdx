...
```jsx live
<Box>
    <TextField error="default" mb="xs"/>
</Box>
<Box>
    <TextField error="error" mb="xs"/>
</Box>
<Box>
    <TextField error="warning" mb="xs"/>
</Box>
<Box>
    <TextField error="success"/>
</Box>
```
...
<Box>
    <TextField icon={<Icon type="errorAlert"/>} />
</Box>
```
