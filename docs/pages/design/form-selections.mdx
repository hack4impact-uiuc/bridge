...
import { Box, Flex, Radio, Text, Checkbox, Icon, Dropdown } from '@hack4impact-uiuc/bridge'
...
<Row>
    ...
    <Col>
       <CodeExampleBox p="32px" width="280px">
            ...
            <Checkbox.Group vertical ml="24px" name="colors">
                <Checkbox id="blue-c2" value="blue">
                    Blue
                </Checkbox>
                <Checkbox id="red-c2" value="red">
                    Red
                </Checkbox>
                <Checkbox defaultChecked id="purple-c2" value="purple">
                    Purple
                </Checkbox>
                <Checkbox id="green-c2" value="green">
                    Green
                </Checkbox>
            </Checkbox.Group>
