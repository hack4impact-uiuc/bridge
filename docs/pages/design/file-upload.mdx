...
import FileUploadError from '../../public/docs-content/design/file-upload/file-upload-error.svg'
...
- File upload errors should be located  8 px under the file with the error.
- These errors use body text size. 
- Error icons should be 8 px from the beginning of the error message.
